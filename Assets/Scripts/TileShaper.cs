...
{
    [SerializeField] private static GameObject stoneTile;
    [SerializeField] private static int myStaticVariable = 0;

    static public GameObject LeftTileSensor;
    static public GameObject RightTileSensor;
    static public GameObject AboveTileSensor;
    static public GameObject BelowTileSensor;
    int currentTile;
